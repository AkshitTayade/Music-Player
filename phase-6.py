...
root.title("Musixstaan")

#assigning icon to the title
root.iconbitmap(r'Pictures/Music/title_icon.ico')
...
#creating status bar
status_bar = Label(root, text = 'Created by Akshit Tayade', font= ('Times 13 italic'),relief=FLAT,anchor=W)
...
img_ = PhotoImage(file="Pictures/rsz_upper.png")
label_image_ = Label(upper_frame, image=img_)
label_image_.pack()

#inserting image into background
img = PhotoImage(file="Pictures/rsz.png")
...
img1 = PhotoImage(file="Pictures/play-button.png")
...
img2 = PhotoImage(file="Pictures/stop.png")
...
img4 = PhotoImage(file='Pictures/pause.png')
...
img5 = PhotoImage(file="Pictures/rewind.png")
...
img9 = PhotoImage(file="Pictures/fast-forward.png")
forward_button = Button(lower_frame, image = img9)
#forward_button.configure(relief=FLAT)
forward_button.place(x=360,y=120)

#creating mute button
img6 = PhotoImage(file="Pictures/volume-up-indicator.png")
img7 = PhotoImage(file="Pictures/volume-off-indicator.png")
...
img8 = PhotoImage(file="Pictures/minus.png")
...
img3 = PhotoImage(file="Pictures/add.png")
...
def on_closing():
    mixer.music.stop()
    messagebox.showinfo("Enjoy","Thanks for choosing Akshit's player \nSee you soon !")
    root.destroy()
